...
//     try {
//       const response = await fetch("https://glow-server.onrender.com/login", {
//         method: "POST",
//         headers: {
...
//     try {
//       const response = await fetch("https://glow-server.onrender.com/signup", {
//         method: "POST",
//         headers: {
//           Accept: "application/json",
//           "Content-Type": "application/json",
...
//               className="h-[20px] md:h-[50px] w-full pl-4 border-[1px] border-[#020200]"
//             />
//           ) : (
//             <></>
//           )}
...
//           }}
//           className="w-full h-[30px] md:h-[60px] bg-[#020200] text-white mt-5 cursor-pointer"
//         >
//           Continue
//         </button>
//         {state === "Sign Up" ? (
