...
const ProductDisplay = (props) => {
  ...
  return (
    <div className='md:grid md:grid-cols-2 gap-4 p-9 bg-[#f5f1f2]'>
      ...
      <div>
      <button onClick={()=>{addToCart(product.id)}} className='font-sans w-32 h-6 md:w-40 md:h-10 bg-[#020200] hover:scale-110 transition ease-in-out  text-white rounded-full cursor-pointer text-center mt-6'>ADD TO CART</button>
      </div>
